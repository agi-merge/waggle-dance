...
export const AGENT_PROMPTING_METHOD_VALUES = {
  [AgentPromptingMethod.ZeroShotReAct]: "zero-shot-react-description" as AgentType,
  [AgentPromptingMethod.ChatZeroShotReAct]: "chat-zero-shot-react-description" as AgentType,
  [AgentPromptingMethod.ChatConversationalReAct]: "chat-conversational-react-description" as AgentType,
}

export function getAgentPromptingMethodValue(method: AgentPromptingMethod): AgentType {
  switch (method) {
